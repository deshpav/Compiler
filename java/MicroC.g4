...
*/
return_stmt returns [ReturnNode node] : 'return' expr 
     {FunctionSymbolTableEntry currFunc = st.getFunctionSymbol(st.currentScope().getName()); $node = new ReturnNode($expr.node, currFunc);};
